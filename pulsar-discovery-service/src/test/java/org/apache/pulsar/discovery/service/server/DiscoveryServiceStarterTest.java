...
public class DiscoveryServiceStarterTest {
    @Test
    public void testMainGenerateDocs() throws Exception {
        ...
        try {
            ...
            Class argumentsClass =
                    Class.forName("org.apache.pulsar.discovery.service.server.DiscoveryServiceStarter$Arguments");

            DiscoveryServiceStarter.main(new String[]{"-g"});
